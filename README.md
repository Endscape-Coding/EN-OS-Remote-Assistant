...
You can use [Remote Assistant Creator](https://github.com/Endscape-Coding/EN-OS-Remote-Assistant-Creator/releases/tag/v0.2.0) for build and configure my program with simple QT6 GUI.  
