...
//! 
//! Пример: ```/input``` или ```/input <клавиша или сочетание из доступных>```  
//! 
use std::io;
        ...
        Botcommand::Input(args) => {
            ...
            if !ydt {
                ...
                return Err(io::Error::new(
                    ...
                    "Ydotool not installed correctly!",
                ));
            }
            if args.trim().is_empty() {
                ...
                let buttons = vec![
                    ...
                    vec![
                        KeyboardButton::new("/input q"),
                        KeyboardButton::new("/input w"),
                        KeyboardButton::new("/input e"),
                        KeyboardButton::new("/input r"),
                    ],
                    vec![
                        KeyboardButton::new("/input t"),
                        KeyboardButton::new("/input y"),
                        KeyboardButton::new("/input u"),
                        KeyboardButton::new("/input i"),
                    ],
                    vec![
                        KeyboardButton::new("/input o"),
                        KeyboardButton::new("/input p"),
                    ],
                    vec![
                        KeyboardButton::new("/input a"),
                        KeyboardButton::new("/input s"),
                        KeyboardButton::new("/input d"),
                        KeyboardButton::new("/input f"),
                    ],
                    vec![
                        KeyboardButton::new("/input g"),
                        KeyboardButton::new("/input h"),
                        KeyboardButton::new("/input j"),
                        KeyboardButton::new("/input k"),
                    ],
                    vec![KeyboardButton::new("/input l")],
                    vec![
                        KeyboardButton::new("/input z"),
                        KeyboardButton::new("/input x"),
                        KeyboardButton::new("/input c"),
                        KeyboardButton::new("/input v"),
                    ],
                    vec![
                        KeyboardButton::new("/input b"),
                        KeyboardButton::new("/input n"),
                        KeyboardButton::new("/input m"),
                    ],
                    vec![
                        KeyboardButton::new("/input й"),
                        KeyboardButton::new("/input ц"),
                        KeyboardButton::new("/input у"),
                        KeyboardButton::new("/input к"),
                    ],
                    vec![
                        KeyboardButton::new("/input е"),
                        KeyboardButton::new("/input н"),
                        KeyboardButton::new("/input г"),
                        KeyboardButton::new("/input ш"),
                    ],
                    vec![
                        KeyboardButton::new("/input щ"),
                        KeyboardButton::new("/input з"),
                        KeyboardButton::new("/input х"),
                        KeyboardButton::new("/input ъ"),
                    ],
                    vec![
                        KeyboardButton::new("/input ф"),
                        KeyboardButton::new("/input ы"),
                        KeyboardButton::new("/input в"),
                        KeyboardButton::new("/input а"),
                    ],
                    vec![
                        KeyboardButton::new("/input п"),
                        KeyboardButton::new("/input р"),
                        KeyboardButton::new("/input о"),
                        KeyboardButton::new("/input л"),
                    ],
                    vec![
                        KeyboardButton::new("/input д"),
                        KeyboardButton::new("/input ж"),
                        KeyboardButton::new("/input э"),
                    ],
                    vec![
                        KeyboardButton::new("/input я"),
                        KeyboardButton::new("/input ч"),
                        KeyboardButton::new("/input с"),
                        KeyboardButton::new("/input м"),
                    ],
                    vec![
                        KeyboardButton::new("/input и"),
                        KeyboardButton::new("/input т"),
                        KeyboardButton::new("/input ь"),
                        KeyboardButton::new("/input ю"),
                    ],
                    vec![KeyboardButton::new("/input ё")],
                    vec![
                        KeyboardButton::new("/input 1"),
                        KeyboardButton::new("/input 2"),
                        KeyboardButton::new("/input 3"),
                        KeyboardButton::new("/input 4"),
                        KeyboardButton::new("/input 5"),
                    ],
                    vec![
                        KeyboardButton::new("/input 6"),
                        KeyboardButton::new("/input 7"),
                        KeyboardButton::new("/input 8"),
                        KeyboardButton::new("/input 9"),
...
fn exec_key(key: &str) -> io::Result<&str> {
    ...
    match key {
        ...
        "ctrl+z" => combotwo(29, 44)?,
        "ctrl+y" => combotwo(29, 21)?,
        "ctrl+s" => combotwo(29, 31)?,
        "ctrl+w" => combotwo(29, 17)?,
        "ctrl+f" => combotwo(29, 33)?,
        "ctrl+r" => combotwo(29, 19)?,
        "ctrl+t" => combotwo(29, 20)?,
        "ctrl+n" => combotwo(29, 49)?,
        "ctrl+o" => combotwo(29, 24)?,
        "ctrl+p" => combotwo(29, 25)?,
        "ctrl+l" => combotwo(29, 38)?,
        "ctrl+k" => combotwo(29, 37)?,
        "ctrl+enter" => combotwo(29, 28)?,

        "alt+tab" => combotwo(56, 15)?,
        "alt+f4" => combotwo(56, 62)?,
        "alt+enter" => combotwo(56, 28)?,
        "alt+space" => combotwo(56, 57)?,

        "shift+tab" => combotwo(42, 15)?,
        "shift+enter" => combotwo(42, 28)?,

        "super+l" => combotwo(125, 38)?,
        "super+d" => combotwo(125, 32)?,
        "super+e" => combotwo(125, 18)?,
        "super+r" => combotwo(125, 19)?,
        "super+t" => combotwo(125, 20)?,
        "super+a" => combotwo(125, 30)?,
